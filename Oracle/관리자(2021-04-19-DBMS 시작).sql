...
-- SQL 코드를 작성할 때 --로 시작되는 문장은 주석이다.
-- SQL 코드는 대소문자 구분이 없다.
-- 단, 키워드는 대문자, 변수 등은 소문자로 사용할 예정
-- 코드는 여러 줄에 걸쳐 작성할 수 있다.
...
--   Oracle 이외의 다른 DBMS 소프트웨어에서는 데이터 저장소를 "DataBase"라고 한다.
--  생성하기 : CREATE
...
-- DRDP : CREAETE로 생성한 개체(Object, 요소)를 제거하는 명령
DROP TABLESPACE mydb
INCLUDING CONTENTS AND DATAFILES
CASCADE CONSTRAINTS;

-- 사용자 생성하기
-- Oracle MBMS에 접속하여 명령을 수행할 수 있는 사용자 계정 추가
